...
; (function () {
  ...
  // console.log(myContractInstance.minter())
  // myContractInstance.minter((err, res) => console.log(res))
  // myContractInstance.call.minter((err, res) => console.log(res))
  // myContractInstance.minter({ from: web3.eth.accounts[0], to: web3.eth.accounts[1], value: 400000 }, (err, res) => console.log(res))
})();
